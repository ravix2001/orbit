...
public class ModifierController {
    ...
    @GetMapping("/getSizeGroup/{id}")
    public ResponseEntity<SizeGroupDTO> getSizeGroupDTOById(@PathVariable Long id) {
        return ResponseEntity.ok(modifierService.getSizeGroupDTOById(id));
    }

    @GetMapping("/getColorGroup/{id}")
    public ResponseEntity<ColorGroupDTO> getColorGroupDTOById(@PathVariable Long id) {
