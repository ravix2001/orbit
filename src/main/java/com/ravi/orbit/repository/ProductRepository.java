...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query("SELECT NEW com.ravi.orbit.dto.ProductDTO(p.id, p.code, p.name, p.brand, p.features, p.description, " +
    ...
    @Query("SELECT NEW com.ravi.orbit.dto.ProductDTO(p.id, p.name, p.brand, p.features, p.description, p.marketPrice," +
